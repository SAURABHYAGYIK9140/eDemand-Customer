...
class AuthenticationRepository {
  ...
  Future verifyPhoneNumber(
    ...
    await _auth.verifyPhoneNumber(
      ...
      codeSent: (final String verification, final int? forceResendingToken) {
        ...
        //     key: HiveRepository.resendTokenKey,
        //     value: forceResendingToken);
        //
        //  Hive.box(HiveRepository.authStatusBoxKey).put("resendToken", forceResendingToken);
        if (onCodeSent != null) {
          onCodeSent();
        }
      },
  ...
  static Future<UserDetailsModel> loginUser({
    ...
    try {
      ...
      // await HiveRepository.putValuesOf(
      //     boxName: HiveRepository.userDetailBoxKey,
      //     key: HiveRepository.latitudeKey,
      //     value: latitude);
      // await HiveRepository.putValuesOf(
      //     boxName: HiveRepository.userDetailBoxKey,
      //     key: HiveRepository.longitudeKey,
      //     value: longitude);
  ...
  Future<Map<String, dynamic>> verifyUserMobileNumberFromAPI(
    ...
    try {
      ...
      print("verifyUserMobileNumberFromAPI"+response.toString());
