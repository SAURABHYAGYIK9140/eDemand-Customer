...
class _OtpVerificationScreenState extends State<OtpVerificationScreen> with CodeAutoFill {
  ...
  Widget _responseMessages(final ResendOtpState resendOtpState) =>
      CustomSizedBox(
        height: 30,
        child: Builder(
  ...
  Widget _resendCountDownButton() =>
      Row(
        ...
        children: [
          ...
          countDownTimer.listenText(color: Theme
              .of(context)
              .colorScheme
              .lightGreyColor)
        ],
  ...
  Widget _buildOtpField(final BuildContext context) =>
      Padding(
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          if (context
                              .watch<VerifyOtpCubit>()
                              .state is VerifyOtpInProcess) ...[
  ...
  Widget _buildOTPverificationStatus(final BuildContext context) =>
      CustomSizedBox(
        height: 30,
        child: Builder(
          builder: (context) =>
