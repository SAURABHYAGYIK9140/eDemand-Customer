          ...
          Row(
            ...
            children: [
              CustomText("${"invoiceNumber".translate(context: context)}: ",
                  color: Theme.of(context).colorScheme.lightGreyColor),
              CustomText(invoiceNumber, color: Theme.of(context).colorScheme.accentColor),
              const Spacer(),
              CustomText(
                price.priceFormat(),
      ...
      Column(
        ...
        children: List.generate(servicesList.length, (int index) {
          ...
          final int serviceRating = int.parse(
            (servicesList[index].rating ?? 0).toString().isEmpty
                ? '0'
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Spacer(),
                    CustomText(totalPriceOfService.toString().priceFormat(),
                        color: Theme.of(context).colorScheme.lightGreyColor),
                  ],
                ),
                      ...
                      CustomInkWellContainer(
                        ...
                        child: Row(
                          children: List.generate(
                            5,
                            (final int serviceIndex) => CustomContainer(
  ...
  Padding _getPriceSectionTile({
    ...
    final FontWeight? fontWeight,
      ...
      Padding(
        ...
        child: Row(
          children: [
            CustomText(heading, color: textColor, fontWeight: fontWeight),
            const Spacer(),
            CustomText(subHeading, color: textColor, fontWeight: fontWeight),
          ],
        ),
      );
